...
public class notBefore implements CustomSWRLFunction {
	...
	public boolean apply(ABox abox, Node[] args) {
		...
		try {
			...
			Method method                              = SWRLBuiltInLibraryImpl.class.getMethod("notBefore", List.class);
			...
			//System.out.println("The invoked \"notBefore\" BuiltInMethod returned: " + (builtinReturn = tempBuiltLib.invokeBuiltInMethod(method, null, "ruleName", "temporal", "notBefore", 0, false, arguments)));
			//System.out.println(">>>>>\n");
