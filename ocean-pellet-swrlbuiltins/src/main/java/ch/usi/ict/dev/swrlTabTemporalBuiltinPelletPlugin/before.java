...
public class before implements CustomSWRLFunction {
	...
	public boolean apply(ABox abox, Node[] args) {
		...
		try {
			...
			Method method                              = SWRLBuiltInLibraryImpl.class.getMethod("before", List.class);
			...
			//System.out.println("the invoked \"before\" BuiltInMethod returned: " + (builtinReturn = tempBuiltLib.invokeBuiltInMethod(method, null, "ruleName", "temporal", "before", 0, false, arguments)));
			//System.out.println(">>>>>\n");
